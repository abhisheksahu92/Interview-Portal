...
def other_company(db):
    return Company.objects.create(name="Other Staffing")


@pytest.fixture
def owner(company):
    user = User.objects.create_user(email="owner@market.test", password="pw12345678")
...
def free_pack(db):
    ...
    return QuestionPack.objects.get(slug="python-fundamentals")
...
def paid_pack(db):
    ...
    return QuestionPack.objects.get(slug="django-essentials")
